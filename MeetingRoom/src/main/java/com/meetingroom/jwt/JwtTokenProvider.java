...
public class JwtTokenProvider {
	...
	public Authentication getAuthentication(HttpServletRequest request) {
		...
		List<GrantedAuthority> authorities = java.util.Arrays.stream(claims.get("roles").toString().split(","))
				.map(role -> role.startsWith("ROLE_") ? role : "ROLE+_" + role).map(SimpleGrantedAuthority::new)
